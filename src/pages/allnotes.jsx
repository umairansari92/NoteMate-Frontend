			...
			<Navbar />
				...
				<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
					{filteredNotes.map(note => (
						<div key={note._id} className="bg-[#0f172a] border border-slate-700 p-5 rounded-2xl shadow-lg ring-1 ring-indigo-500/5 hover:ring-indigo-500/15 transition-all hover:shadow-xl hover:-translate-y-0.5">
							{editingId === note._id ? (
								...
								<>
									...
									<p className="text-gray-700 dark:text-slate-300 mt-1 whitespace-pre-wrap break-words">{note.content}</p>
								</>
							)}
